...
import numpy as np
import pandas as pd
from core_agent import DDQNAgent


def run_ddqn(env_name, episodes, seed, output_path):
    ...
    print(f"✅ DDQN training complete. Results saved to {output_path}")
...
if __name__ == "__main__":
    ...
    parser.add_argument("--out", type=str, default="ddqn_output.csv")
    args = parser.parse_args()

    run_ddqn(args.env, args.episodes, args.seed, args.out)
